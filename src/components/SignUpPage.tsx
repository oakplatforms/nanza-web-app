  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-gray-100 to-gray-300">
      <div className="w-full max-w-sm bg-white px-10 pt-8 pb-9 shadow-[rgba(50,50,93,0.25)_0px_50px_100px_-20px,rgba(0,0,0,0.3)_0px_30px_60px_-30px] rounded-2xl">
        ...
        <p className="text-[13px] text-slate-800 font-medium tracking-[0.05px] mb-6">
        ...
        <p className="text-[13px] text-slate-800 font-medium tracking-[0.05px] mt-6">
          ...
          <button onClick={() => navigate('/login')} className="ml-1 font-semibold text-sky-500 hover:text-sky-600 inline-flex items-center">
            Sign In
